...
**예시 질문**
- 어떤 조건 하에서 SQ1에서 가장 빠른 랩타임의 107%를 초과해도 탈락하지 않을 수 있나요?

#### 5) 테스트 케이스

| 테스트 ID | 질문 | 테스트 목적 |
|---|---|---|
| **F1QA001** | Pistons는 어떤 금속 혼합물로부터 제조되어야 하는가? | 기술 규정 기반 정확성 평가 |
| **F1QA002** | 경기 세션은 언제 열립니까? | 경기 운영 규정 이해도 평가 |
| **F1QA003** | Heat Hazard가 선언되는 조건 중 하나는 무엇인가? | 운영 규정 기반 조건 이해 평가 |
| **F1QA004** | 시상식에서 몇 개의 트로피가 수여될까요? | 스포츠 규정 기반 사실 응답 평가 |
| **F1QA005** | Current Car(CC)는 어떤 차량을 의미합니까? | 용어 정의 정확성 평가 |
| **F1QA006** | LTC, TRC, 또는 FSC는 무엇을 의미합니까? | 약어/용어 설명 능력 평가 |
| **F1QA007** | 이 텍스트는 어떤 규정에 대한 내용을 담고 있나요? | 문서 분류 및 맥락 이해 평가 |
| **F1QA008** | 어떤 조건 하에서 SQ1에서 제일 빠른 라운드 시간을 초과한 선수가 탈락하지 않고 계속 진행할 수 있나요? | 예외 조항 설명 능력 평가 |
...
> 특히 단순 정의형 질문과 조문 근거가 명확한 질문에서는 높은 정확도를 보였다.
